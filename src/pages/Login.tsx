...
function PinInput({
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <label className="text-xs font-medium text-text-tertiary uppercase tracking-[0.05em]">
                ...
                success
                  ...
                  : error
                    ...
                    : pin[i]
                      ...
                      : 'border-2 border-border-default bg-bg-tertiary/80'
              } ${
...
function RateLimitOverlay({ remainingMs }: { remainingMs: number }) {
  ...
  return (
    <motion.div
      ...
      className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-bg-secondary/95 backdrop-blur-xl rounded-xl border border-accent-amber/30 animate-pulse-glow"
    >
  ...
  return (
    <div className="fixed inset-0 min-h-[100dvh] flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, rgba(11,17,32,0.88) 0%, rgba(11,17,32,0.97) 100%)',
        }}
      />
      ...
      >
        <div className="glass-light rounded-xl border border-white/10 p-9 shadow-[0_25px_80px_rgba(0,0,0,0.5),0_0_0_1px_rgba(59,130,246,0.05)] relative overflow-hidden">
          ...
          >
            ...
            <motion.p
              ...
              className="text-sm text-text-tertiary font-medium uppercase tracking-[0.08em]"
            >
              ...
              >
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-[2.1rem] text-text-tertiary hover:text-text-secondary transition-colors"
                  >
          ...
          <div className="flex items-center gap-3 mt-5 mb-5">
            <button
              ...
              style={{
                backgroundColor: usePassword ? '#22C55E' : 'rgba(100,116,139,0.3)',
              }}
            >
              <span
                className="inline-block h-[18px] w-[18px] transform rounded-full bg-text-primary transition-transform"
                style={{
          ...
          <motion.button
            ...
            className={`w-full h-12 rounded-md font-semibold text-sm tracking-[0.1em] transition-all duration-200 flex items-center justify-center gap-2 ${
              success
                ? 'bg-accent-green text-white'
                : 'gradient-accent text-white hover:brightness-110 hover:-translate-y-0.5 hover:shadow-accent active:scale-[0.98] active:brightness-95'
        ...
        <motion.a
          ...
          href="#"
          className="flex items-center justify-center gap-1.5 mt-4 text-xs text-text-tertiary hover:text-text-secondary hover:underline transition-colors"
        >
